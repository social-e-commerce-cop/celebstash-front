    ...
    <View style={[styles.container, { paddingHorizontal: width * 0.05 }]}>
      ...
      <View style={styles.row}>
        ...
        <View style={styles.priceColumn}>
          <Text style={[styles.totalPrice, { fontSize: width * 0.045 }]}>
            Total Price
          </Text>
          <Text style={[styles.totalPrice, { fontSize: width * 0.045 }]}>
            $24.00
        ...
        <TouchableOpacity style={styles.cartButton}>
          <Ionicons name="cart-outline" size={28} color="#FF6A00" />
        </TouchableOpacity>
      </View>
...
const styles = StyleSheet.create({
  container: {
    paddingVertical: 15,
    marginTop: 10, // <-- leaves space under it
  },
  row: {
    flexDirection: "row",
