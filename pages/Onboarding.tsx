...
const styles = StyleSheet.create({
    ...
    logoText: { color: "#7126D0", fontSize: 24, fontWeight: "700", fontFamily: "Poppins-Bold" },
    ...
    heroText: { fontSize: 18, fontWeight: "bold", lineHeight: 26, color: "#333", textAlign: "center", maxWidth: 320, fontFamily: "Poppins-Bold" },
    getStartedBtn: { backgroundColor: "#7126D0", borderRadius: 12, paddingVertical: 16, paddingHorizontal: 32, width: "100%", maxWidth: 320, alignItems: "center" },
    getStartedText: { color: "#fff", fontWeight: "600", fontSize: 16, fontFamily: "Poppins-Bold" },
});
