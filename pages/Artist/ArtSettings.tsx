...
import { Addres, Dashboard, Language, Logout, Notifications, Privacy, Profile, Security } from "@/assets/icons/Settings";
import { WalletIcon } from "@/assets/icons/Payment";

const { width, height } = Dimensions.get('window');

const ArtSettingsScreen: React.FC = () => {
...
export default ArtSettingsScreen;
