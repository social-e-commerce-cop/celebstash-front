    ...
    <View style={styles.signupScreen}>
      <View style={styles.signupContent}>
        ...
        <View style={styles.mb8}>
          <Text style={styles.formHeaderTitle}>Create an account</Text>
          <Text style={styles.formHeaderText}>Create an account so you can explore all the existing jobs!</Text>
        </View>
